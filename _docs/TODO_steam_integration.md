...
1. **🔄 Роуты** - добавить маршруты для инвентаря
2. **🔄 Blade шаблоны** - создать views для отображения инвентаря
3. **🔄 Запустить миграцию** - применить изменения в базе
4. **🔄 Тестирование** - проверить работу всех компонентов
5. **🔄 Интеграция с авторизацией** - добавить авто-синхронизацию при входе
...
2. Кеш на 15 минут
3. Кнопка "Обновить" для принудительной синхронизации
4. Двойная проверка владения при создании лота
5. Рекомендуемые цены с учетом float и стикеров
