    ...
    'resources' => [
        ...
        'manage' => [
            ...
            \App\Filament\Resources\ClientResource::class => [
                // Кнопки в таблице Клиенты
                'topupBalance',
                'withdrawBalance',
                'topupBonus',
                'withdrawBonus',
                // Кнопки блокировок (на странице редактирования)
                'blockWithdraw',
                'blockItems',
                'blockBalance',
                // Секции на странице клиента (тогл on/off)
                'sectionRigging',
                'sectionPartner',
                // Поля формы — триада View/Edit/None (2 affix-а на поле)
                'viewFieldName', 'updateFieldName',
                'viewFieldEmail', 'updateFieldEmail',
                'viewFieldSteamId', 'updateFieldSteamId',
                'viewFieldSteamAvatar', 'updateFieldSteamAvatar',
                'viewFieldSteamTradeUrl', 'updateFieldSteamTradeUrl',
                'viewFieldBalance', 'updateFieldBalance',
                'viewFieldBonusBalance', 'updateFieldBonusBalance',
                'viewFieldTelegramId', 'updateFieldTelegramId',
                'viewFieldIsVerified', 'updateFieldIsVerified',
                'viewFieldIsBot', 'updateFieldIsBot',
                'viewFieldLocale', 'updateFieldLocale',
                'viewFieldAdminComment', 'updateFieldAdminComment',
            ],
        ],
        'exclude' => [
            //
