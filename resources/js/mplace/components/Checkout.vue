						...
						<div class="row align-items-center">
							<div class="col-md-8 mb-2 mb-md-0">
								<h5 class="mb-1">Заказ на сумму: <strong class="text-primary"
										v-html="formatPrice(cartTotal)"></strong></h5>
								<p class="text-muted mb-0">Товаров: {{ cartItems.length }}</p>
							</div>
							<div class="col-md-4 text-end">
								<button class="btn theme-btn" @click="placeOrder" :disabled="isProcessing">
		...
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				...
				<div class="modal-body text-center">
					...
					<h4 class="mt-3">{{ createdOrders.length === 1 ? 'Заказ успешно оформлен!' : `Оформлено заказов:
						${createdOrders.length}` }}</h4>
