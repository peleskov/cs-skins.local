<template>
	<div id="Orders" class="change-profile-content position-relative">
		...
		<div class="title">
			...
			<h3 class="mb-4 mb-lg-0">Мои покупки</h3>
		</div>
		...
		<div class="tab-content" id="ordersTabContent">
			...
			<div class="tab-pane fade show active" id="current" role="tabpanel" aria-labelledby="current-tab"
				...
				<div v-if="!isLoading && orders.length > 0" class="orders-list">
					<OrderItem v-for="order in orders" :key="order.id" :order="order" user-type="seller"
